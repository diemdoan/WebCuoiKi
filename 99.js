const music = new Audio('audio/99_audio/1.mp3');

const songs = [
    {
        id: '1',
        songName: '00<br><div class="subtitle">RPT MCK</div>',
        poster: "Img/99_img/1.jpg"
    },
    {
        id: '2',
        songName: 'Chìm Sâu<br><div class="subtitle">RPT MCK</div>',
        poster: "Img/99_img/2.jpg"
    },
    {
        id: '3',
        songName: 'Suit & Tie<br><div class="subtitle">RPT MCK</div>',
        poster: "Img/99_img/3.jpg"
    },
    {
        id: '4',
        songName: 'Va Vào Giai Điệu Này<br><div class="subtitle">RPT MCK</div>',
        poster: "Img/99_img/4.jpg"
    },
    {
        id: '5',
        songName: 'Tối Nay Ta Đi Đâu Nhờ<br><div class="subtitle">RPT MCK</div>',
        poster: "Img/99_img/5.jpg"
    },
    {
        id: '6',
        songName: 'Chỉ Một Đêm Nữa Thôi<br><div class="subtitle">RPT MCK</div>',
        poster: "Img/99_img/6.jpg"
    },
    {
        id: '7',
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((element) => {
    element.addEventListener('click', (e) => {
        ...
        music.src = `audio/99_audio/${index}.mp3`;
        download_music.href = `audio/99_audio/${index}.mp3`;
        poster_master_play.src = `Img/99_img/${index}.jpg`;
        music.play();
...
songs.forEach(element =>{
    ...
    card.addEventListener('click', ()=> {
        ...
        music.src = `audio/99_audio/${id}.mp3`;
        download_music.href = `audio/99_audio/${id}.mp3`;
        poster_master_play.src = `Img/99_img/${id}.jpg`;
        music.play();
        let song_title = songs.filter((ele) => {
            return ele.id == id;
        });
